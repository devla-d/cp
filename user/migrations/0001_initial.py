# Generated by Django 4.0.3 on 2022-11-25 06:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique_u', models.CharField(blank=True, max_length=30, null=True, unique=True)),
                ('bank_details', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='trans_bank', to='user.bank')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('package', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='pack', to='user.packages')),
